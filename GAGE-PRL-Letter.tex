...
All pins, scripts, and figure data are archived at Zenodo (\texttt{GAGE\_repo v1.0.0}, DOI \href{https://doi.org/10.5281/zenodo.17537647}{10.5281/zenodo.17537647}). The Letter and Supplemental Material contain all equations, definitions, and figure descriptions. Additional materials are available from the author upon reasonable request.
