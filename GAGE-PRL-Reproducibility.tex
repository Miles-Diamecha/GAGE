...
numerical precision: 
$\Delta(\Lambda_\chi)/\Lambda_\chi=1.7\times10^{-6}$, 
$\Delta(\Omega_\chi/\alpha_G^{(pp)})=5.2\times10^{-6}$, 
$\cos\theta=1.0000000$.  
SHA-256 hashes are recorded in \texttt{stdout.txt}.

\paragraph*{SHA256 verification}
\begin{align*}
08f0371b31def20a1f89727c42b2ad183dd320460f2da084e78e6916c7cd5edc &\quad \texttt{results.json} \\
4a4fea99a4aa905ae0cb3c1900234a77765e1b98acc5b64989428d1ef0349e4a &\quad \texttt{metric\_results.json} \\
0f232a0be6f87e19e7a2c9ca9b6001b7cc2f2a7508f21dcc6c6a296426fae3b0 &\quad \texttt{stdout.txt}
\end{align*}
